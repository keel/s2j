...
public class LocalSentence extends Sentence {
	...
	public boolean exec() {
		...
		v.setName(ws[1]);
		v.setOut(name);
		Var v1 = SentenceMgr.getVar(ws[1]);
		//String val = (v1.getValue() == null) ? v1.getOut() : v1.getValue().toString();
		this.out.append(obj).append(" ").append(name).append(" = ").append(v1.getOut());
